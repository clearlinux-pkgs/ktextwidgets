...
Version  : 5.113.0
Release  : 72
URL      : https://download.kde.org/stable/frameworks/5.113/ktextwidgets-5.113.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.113/ktextwidgets-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/ktextwidgets-5.113.0.tar.xz.sig
...
%prep
%setup -q -n ktextwidgets-5.113.0
cd %{_builddir}/ktextwidgets-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702997450
mkdir -p clr-build
pushd clr-build
