...
Source0  : https://download.kde.org/stable/frameworks/5.62/ktextwidgets-5.62.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.62/ktextwidgets-5.62.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568917314
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5TextWidgets.so.5.62.0
