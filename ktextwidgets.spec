...
Source0  : https://download.kde.org/stable/frameworks/5.58/ktextwidgets-5.58.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.58/ktextwidgets-5.58.0.tar.xz.sig
Summary  : Advanced text editing widgets
Group    : Development/Tools
License  : LGPL-2.0 LGPL-2.1
Requires: ktextwidgets-data = %{version}-%{release}
...
export LANG=C
export SOURCE_DATE_EPOCH=1557789367
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5TextWidgets.so.5.58.0
